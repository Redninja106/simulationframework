...
//    protected virtual void VisitStructs(IEnumerable<ShaderStructure> structs)
//    {
...
//    protected virtual void VisitMethods(IEnumerable<ShaderMethod> methods)
//    {
...
//    protected virtual void VisitMethod(ShaderMethod method)
//    {
//        Writer.WriteLine();
...
//            Writer.Write('_');
//            VisitIdentifier(method.BaseName);
//        }
//        Writer.Write('(');
...
//    {
//        if (expression.IfFalse is not (System.Linq.Expressions.BlockExpression or GotoExpression) && expression.IfTrue is not (System.Linq.Expressions.BlockExpression or GotoExpression))
//        {
//            // ternary
//            base.Visit(expression.Test);
//            Writer.Write(" ? ");
//            base.Visit(expression.IfTrue);
//            Writer.Write(" : ");
//            base.Visit(expression.IfFalse);
...
//                expr = (expr as System.Linq.Expressions.BlockExpression)!.Expressions.First();
...
//    protected virtual void VisitStruct(ShaderStructure @struct)
//    {
//        Writer.WriteLine();
//        Writer.Write("struct ");
...
//        Writer.Write('_');
//        VisitIdentifier(node.Method.BaseName);
...
//    protected bool NeedsParentheses(ExpressionType parent, ExpressionType child)
//    {
